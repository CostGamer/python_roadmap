...
## `34.8` Context Manager — паттерн `with` и протокол `__enter__`/`__exit__`
...
## `34.9` Async Context Manager — `async with` и `__aenter__`/`__aexit__`
...
## `34.10` Async Decorator — декораторы для асинхронных функций
...
## `34.11` Dependency Injection — внедрение зависимостей
